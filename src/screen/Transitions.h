...
protected:
	Display*		m_NextScreen;
	Display*		m_PreviousScreen;
	TweenManager*	m_TweenManager;

public:
	void	SetNextScreen(Display& value)		{ m_NextScreen = &value; };
	void	SetPreviousScreen(Display& value)	{ m_PreviousScreen = &value; };
